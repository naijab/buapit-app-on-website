...
<title><?= $web_title; ?> : จัดการข้อความแจ้งเตือน</title>
</head>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table_content">
                      <div class="card">
                          <div class="header bg-orange">
                              <h2>จัดการข้อความแจ้งเตือน
                              </h2>

                          </div>
                          <div class="body">
                            <button class="btn btn-success waves-effect waves-float" data-toggle="modal" data-target="#add_new_record_modal">ส่งข้อความใหม่</button>
...
<tbody>
  <?php
        $stmt = $db_con->prepare("SELECT * FROM buapit_noti WHERE {$row['user_id']} ORDER BY noti_id DESC");
        $stmt->execute();
        ...
        ?>
            ...
            <td><?php echo $row['noti_create']; ?></td>
            </tr>
          <?php } ?>
</tbody>
</table>
                  ...
                  <div class="modal fade" id="add_new_record_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    ...
                    <h4 class="modal-title" id="myModalLabel">สร้างข้อความแจ้งเตือนใหม่</h4>
                  </div>
                  <div class="modal-body">
              <!--Add form-->
                <form action="lib/add_noti" method="post" >
                  <div class="row" class="col-md-12">
                    <div class="form-group">
                        <label class="form-label">ข้อความแจ้งเตือน</label>
                        <div class="form-line">
                          <textarea type='text' id='mg' name='mg' class='form-control' placeholder='ใสข้อความแจ้งเตือน' rows="5" cols="20" style="overflow-y: scroll; resize: none;" required></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" onclick="return edit_user_form();" class="btn btn-primary btn-lg">ส่งข้อความ</button>
                  </form>
                  </div>
                </div>
                </div>
